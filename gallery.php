<?php
define("TITLE", "Gallery | In Motion Interiors");
...
<section class=" pt-160 pb-40 bg_cover" style="background-image: url(assets/images/gallery.webp)">
    <div class="container">
        <h1 class="white wow fadeInLeft hero__text" data-wow-duration="1.3s" data-wow-delay="0.2s">Gallery</h1>
    </div>
</section>
<!--====== FEATURES PART START ======-->
        ...
        <div class="row justify-content-left">
            <div class="col-lg-6">
                <div class="section_title text-left">
                    ...
                    <p class="wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.4s">Get To Know <strong>Our Work</strong> and Live Beautifully.</p>
                </div> <!-- section title -->
            </div>
        </div> <!-- row -->
    </div> <!-- container -->
    <div class="portfolio_wrapper centered-portfolio d-flex flex-wrap pt-60">
        ...
        <div class="single_portfolio wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.4s">
            <img loading="lazy" src="assets/images/featured-projects/arcadia.webp" alt="portfolio">
            <div class="portfolio_content">
                <ul class="meta">
                    <li><a href="arcadia.php"><i class="lni lni-link"></i></a></li>
                </ul>
                <h5 class="portfolio_title"><a class="white" href="arcadia.php">Project Arcadia</a></h5>
            </div> <!-- Single portfolio -->
            <div class="portfolio_content_1">
                <ul class="meta">
                    <li><a href="arcadia.php"><i class="lni lni-link"></i></a></li>
        ...
        <div class="single_portfolio wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.4s">
            <img loading="lazy" src="assets/images/featured-projects/nursery.webp" alt="portfolio">
            <div class="portfolio_content">
                <ul class="meta">
                    <li><a href="baby-cruz.php"><i class="lni lni-link"></i></a></li>
                </ul>
                <h5 class="portfolio_title"><a class="white" href="baby-cruz.php">Project Baby Cruz Nursery</a></h5>
            </div> <!-- Single portfolio -->
            <div class="portfolio_content_1">
                <ul class="meta">
                    <li><a href="baby-cruz.php"><i class="lni lni-link"></i></a></li>
        ...
        <div class="single_portfolio wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.4s">
            <img loading="lazy" src="assets/images/featured-projects/cherry.webp" alt="portfolio">
            <div class="portfolio_content">
                <ul class="meta">
                    <li><a href="cherry-place.php"><i class="lni lni-link"></i></a></li>
                </ul>
                <h5 class="portfolio_title"><a class="white" href="cherry-place.php">Project Cherry Place</a></h5>
            </div> <!-- Single portfolio -->
            <div class="portfolio_content_1">
                <ul class="meta">
                    <li><a href="cherry-place.php"><i class="lni lni-link"></i></a></li>
        ...
        <div class="single_portfolio wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.4s">
            <img loading="lazy" src="assets/images/featured-projects/egoli.webp" alt="portfolio">
            <div class="portfolio_content">
                <ul class="meta">
                    <li><a href="egoli.php"><i class="lni lni-link"></i></a></li>
                </ul>
                <h5 class="portfolio_title"><a class="white" href="egoli.php">Project Egoli</a></h5>
            </div> <!-- Single portfolio -->
            <div class="portfolio_content_1">
                <ul class="meta">
                    <li><a href="egoli.php"><i class="lni lni-link"></i></a></li>
        ...
        <div class="single_portfolio wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.4s">
            <img loading="lazy" src="assets/images/featured-projects/greenstone.webp" alt="portfolio">
            <div class="portfolio_content">
                <ul class="meta">
                    <li><a href="greenstone-house.php"><i class="lni lni-link"></i></a></li>
                </ul>
                <h5 class="portfolio_title"><a class="white" href="greenstone-house.php">Project Greenstone House</a></h5>
            </div> <!-- Single portfolio -->
            <div class="portfolio_content_1">
                <ul class="meta">
                    <li><a href="greenstone-house.php"><i class="lni lni-link"></i></a></li>
        ...
        <div class="single_portfolio wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.4s">
            <img loading="lazy" src="assets/images/featured-projects/kyalami.webp" alt="portfolio">
            <div class="portfolio_content">
                <ul class="meta">
                    <li><a href="kyalami-gardens.php"><i class="lni lni-link"></i></a></li>
                </ul>
        ...
        <div class="single_portfolio wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.4s">
            ...
            <div class="portfolio_content">
                <ul class="meta">
                    <li><a href="sela.php"><i class="lni lni-link"></i></a></li>
                </ul>
                <h5 class="portfolio_title"><a class="white" href="sela.php">Project Sela</a></h5>
            </div> <!-- Single portfolio -->
            <div class="portfolio_content_1">
                <ul class="meta">
                    <li><a href="sela.php"><i class="lni lni-link"></i></a></li>
